...
from core.models import signup, login, get_user, create_playlist, add_track_to_playlist, get_recommended_songs, \
    get_best_artist_songs
...
def update_menu(username):
    ...
    search_all_singers_item = FunctionItem("Search singer's best songs", best_songs_for_artist,
                                           [username, "4Uzm4t6wAufWqKP7ZgYLxF"])
